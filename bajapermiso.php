...
----->
            ...
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
								      ...
								      <td><a href="bajapermiso.php? borrar=<?php echo $fila["id_Tpermiso"]; ?>">Modificar</a> </td>									   
				   ...
				   <div class="container"> 
            <form id="contact" action="bajapermiso.php" method="POST"  > 
  ...
  if ($idForm==""){
		...
		echo $idForm;
		  ...
		  $consultaform="SELECT *FROM Tipo_permiso WHERE id_Tpermiso='".$idForm."'";
 ...
 <fieldset>
  ...
  <fieldset>
      <button name="modificar" type="submit" id="contact-submit" data-submit="...Sending">ACTUALIZAR</button>
                       ...
                       <li>
                     <a href="bajapermiso.php" class="waves-effect waves-dark">REGRESAR AL INICIO</a>
                            </li>
...
if(isset ($_POST['modificar']))
{
								...
								$consulta="UPDATE Tipo_permiso SET status='$editar_statu',Tipo='$editar_tip' WHERE  id_Tpermiso='".$editar_id."'";
								...
								//header("Location: bajapermiso.php");	
								//echo '<meta http-equv="refresh" content="1; url=Modificar.php" >';
								echo "<script>
								location.href='bajapermiso.php'
