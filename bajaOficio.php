...
<ul class="nav nav-second-level">
  ...
  <li>
             ...
             <li>    
					...
					<ul class="nav nav-second-level">
                             ...
                             <li>
                                <a href="MODoficio.php" class="waves-effect waves-dark"> Modificar Datos</a>
                            </li>
  ...
  ------->
            ...
            <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
											...
											<td><a href="bajaOficio.php? borrar=<?php echo $fila["id_oficio"]; ?>">Modificar</a> </td>
			  ...
			  <div class="container"> 
            <form id="contact" action="bajaOficio.php" method="POST"  > 
 ...
 <fieldset>
  ...
  <fieldset>
      <button name="modificar" type="submit" id="contact-submit" data-submit="...Sending">ACTUALIZAR</button>
                       ...
                       <li>
                     <a href="bajaOficio.php" class="waves-effect waves-dark">REGRESAR AL INICIO</a>
                            </li>
...
if(isset ($_POST['modificar']))
{
								...
								$consulta="UPDATE Oficios SET status='$editar_statu' WHERE  id_oficio='".$editar_id."'";
								...
								//header("Location: bajaOficio.php");	
								//echo '<meta http-equv="refresh" content="1; url=Modificar.php" >';
								echo "<script>
								location.href='bajaOficio.php'
	...
	<p class="copyright"><a href="">EMPLEADOS</a></p>
  </form>
</div>  
