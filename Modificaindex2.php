        ...
        <div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                           ...
                           Actualizaciones de empleados del TSJED
                        </h1>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="Modificaindex2.php? editar=<?php echo $fila["id_empleado"]; ?>">Editar</a> </td>
...
<!-- FORMULARIO DEL REGISTRO DE EMPLEADOS-->
					 ...
					 <div class="container"> 
            <form id="contact" action="Modificaindex2.php" method="POST"  > 
		...
		echo $idForm;
		  ...
		  $consultaform="SELECT *FROM Empleados WHERE id_empleado='".$idForm."'";
								  ...
								  $filaform=odbc_fetch_array($ejecutarform);
										...
										$areform=$filaform["area"];
										$catform=$filaform["categoria"];
  ...
  <input   name="idJ" type="hidden"  value="<?php echo $idForm?>" >
 ...
 <fieldset>
  ...
  <fieldset>
	...
	<h5>Area</h5>
      ...
      <input  name="are" type="text"  value="<?php echo $areform?>" required autofocus>
    </fieldset>
    ...
    <fieldset>
	<h5>Categoria</h5>
      <input  name="cat" type="text"  value="<?php echo $catform?>" required autofocus>
    </fieldset>
...
if(isset ($_POST['btnMOD']))
{
								 ...
								 $editar_ar=$_POST['are'];
								 $editar_cate=$_POST['cat'];
								 $editar_name=$_POST['nombre'];

								 
								$consulta2="UPDATE Empleados SET nombre='".$editar_name."',categoria='".$editar_cate."',area='".$editar_ar."',status='".$editar_statu."' WHERE  id_empleado='".$editar_id."'";
								
								//$ejecutar= odbc_exec($conn,$consulta);
								
								$query = odbc_exec($conn, $consulta2) or die ("Problema al ejecutar la consulta"); 
								...
								//header("Location: Modificaindex2.php");	
								//echo '<meta http-equv="refresh" content="1; url=Modificar.php" >';
								echo "<script>
								location.href='Modificaindex2.php'
