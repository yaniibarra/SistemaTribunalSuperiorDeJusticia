...
<ul class="nav nav-second-level">
                         ...
                         <div class="card-content">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									$consulta="SELECT *FROM Superiores";
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                         ...
                                         <td><a href="bajaSuperior.php? borrar=<?php echo $fila["id_jefe"]; ?>">Modificar</a> </td>									   
 ...
 <div class="container"> 
            <form id="contact" action="bajaSuperior.php" method="POST"  > 
  ...
  if ($idForm==""){
		...
		echo $idForm;
		  ...
		  $consultaform="SELECT *FROM Superiores WHERE id_jefe='".$idForm."'";
								  ...
								  $filaform=odbc_fetch_array($ejecutarform);
								        ...
								        $idform=$filaform["id_jefe"];
										$nomform=$filaform["nombre1"];
 ...
 <fieldset>
  ...
  <fieldset>
      <button name="modificar" type="submit" id="contact-submit" data-submit="...Sending">ACTUALIZAR</button>
                       ...
                       <li>
                     <a href="bajaSuperior.php" class="waves-effect waves-dark">REGRESAR AL INICIO</a>
                            </li>
...
if(isset ($_POST['modificar']))
{
								...
								$consulta="UPDATE Superiores SET nombre='$editar_name',status='$editar_statu' WHERE  id_jefe='".$editar_id."'";
								...
								//header("Location: bajaSuperior.php");	
								//echo '<meta http-equv="refresh" content="1; url=Modificar.php" >';
								echo "<script>
								location.href='bajaSuperior.php'
