...
<head>
    ...
    <!--SCRIPTS PARA LA BUSQUEDA DE TABLA-->
    <script type="text/assets/js">
    (function(document){
		'use strict';
...
<ul class="nav nav-second-level">
        ...
        <div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                           ...
                           Consultas de empleados del TSJED
                        </h1>
  ...
  <fieldset>
    ...
    <div id="page-inner"> 
     ...
     <!--fieldset>
      <input placeholder="Buscar" type="text" id="TBLbusqueda" name="txtbuscar" onKeyUp="filtro('table-responsive', this.value, true, 0, event);" >
    </fieldset-->
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <table class="order-table table">
                                ...
                                <table class="order-table table" id="dataTables-example">
