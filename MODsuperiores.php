                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                          ...
                                          <td><a href="MODsuperiores.php? editar=<?php echo $fila["id_jefe"]; ?>">Editar</a> </td>
...
<!-- FORMULARIO DEL REGISTRO DE EMPLEADOS-->
					 ...
					 <div class="container"> 
            <form id="contact" action="MODsuperiores.php" method="POST"  > 
...
if(isset($_POST['modificar'])){
								...
								$consulta="UPDATE Superiores SET nombre1='$editar_name',status='$editar_statu' WHERE id_jefe='".$editar_id."'";
								//$ejecutar= odbc_exec($conn,$consulta);
								...
								//header("Location: MODsuperiores.php");	
								//echo '<meta http-equv="refresh" content="1; url=Modificar.php" >';
								echo "<script>
								location.href='MODsuperiores.php'
